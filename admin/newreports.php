...
<body>
    ...
    // Check if there's an export request
    ...
    <!-- JavaScript to close popups when clicking outside -->
    <script>
        // Close overlay when clicking outside of popup
        document.addEventListener('DOMContentLoaded', function() {
            ...
            overlays.forEach(overlay => {
                overlay.addEventListener('click', function(e) {
                    if (e.target === this) {
                        // Get the close link inside the overlay
                        const closeLink = this.querySelector('.close');
                        if (closeLink) {
                            closeLink.click();
                        }
                    }
            ...
            // Add ESC key functionality to close overlays
            document.addEventListener('keydown', function(e) {
                if (e.key === 'Escape') {
                    // Find all visible overlays and close them
                    const visibleOverlays = document.querySelectorAll('.overlay:target');
                    visibleOverlays.forEach(overlay => {
                        const closeLink = overlay.querySelector('.close');
                        if (closeLink) {
                            closeLink.click();
                        }
                    });
        ...
        menuLinks.forEach(link => {
            link.addEventListener('click', function() {
                // Close any open overlay by navigating away from current page
